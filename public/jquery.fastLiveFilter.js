// Modified this code so that it does not cache DOM contents
...
jQuery.fn.fastLiveFilter = function(list, options) {
	...
	// var len = lis.length;
	var oldDisplay = list.children().length > 0 ? list.children()[0].style.display : "block";
	callback(list.children().length); // do a one-time callback on initialization to make sure everything's in sync
